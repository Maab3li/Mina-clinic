...
return(
    <div id='home' class ='section' className='container place-content-center ml-0 md:ml-0 mt-5 max-w-full justify-center ' style={{width:'100%'}} >
        <div className='pt-14'>
        ...
        <div className='justify-center, mt-10' style={{marging:'0 auto'}}>
            <div class="flex grow justify-center text-xl text-center" style={{display:'block'}}>We present high-quality services with modern techniques to keep your teeth healthy
