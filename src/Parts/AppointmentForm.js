                ...
                <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 md:w-full mx-auto">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="md:col-span-5">
                            <label className="font-bold text-gray-800" for="email">Email</label>
                        ...
                        <div class="md:col-span-3">
                            <label className="font-bold text-gray-800" for="address">Address / Street</label>
                        ...
                        <div class="md:col-span-2">
                            <label className="font-bold text-gray-800" for="country">Country / region</label>
                        ...
                        <div class="md:col-span-2">
                            <label className="font-bold text-gray-800" for="state">State / province</label>
                            <div class="h-10 bg-gray-100 flex border border-gray-200 rounded items-center mt-1">
                        ...
                        <div class="md:col-span-2">
                            <label className="font-bold text-gray-800" for="city">City</label>
                        ...
                        <div class="md:col-span-1">
                            <label className="font-bold text-gray-800" for="NIN">National Number</label>
